...
public class CustomerDetailsBean implements Serializable {
    ...
    /**
     * Retourne la liste de tous les Discount par ordre croissant des taux de réduction.
     * @return 
     */
    public List<Discount> getDiscountsOrdered() {
        return discountManager.getAllDiscountsOrderByRateASC();
    }
